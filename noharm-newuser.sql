...
GRANT update on demo.medicamento TO batch_reports_noharm;
GRANT update on demo.medatributos TO batch_reports_noharm;
GRANT insert on demo.medatributos_audit TO batch_reports_noharm;
grant USAGE, SELECT ON SEQUENCE demo.medatributos_audit_idmedatributos_audit_seq to batch_reports_noharm;
