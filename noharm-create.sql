...
ALTER TABLE demo.prescricao
ADD CONSTRAINT chk_prescricao_nratendimento
CHECK (nratendimento BETWEEN 0 AND 999999999);


ALTER TABLE demo.pessoa
ADD CONSTRAINT chk_pessoa_nratendimento
CHECK (nratendimento BETWEEN 0 AND 999999999);
